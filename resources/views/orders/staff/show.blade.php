    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="flex space-x-8">
            ...
            <div class="flex-1 bg-white p-8 rounded-lg shadow-lg mb-8">
                ...
                <div class="mt-4">
                    <p class="text-xl font-bold text-gray-600">patient: <span class="text-gray-800">{{ $order->user_name }}</span></p>
                    <p class="text-xl font-bold text-gray-600">Card Number: <span class="text-gray-800">{{ $order->card_number }}</span></p>
                </div>
            </div>
            ...
            <form action="{{ route('staff.orders.update', $order->order_code) }}" method="POST">
                ...
                @method('PUT')
                    ...
                    <select name="status" id="status" class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                        <option value="" disabled selected>Update Status</option> <!-- Placeholder option -->
